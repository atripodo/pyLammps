...
def read_pars():
    ...
    if not (os.path.isfile("setup_pars.txt")):
        ...
        f.write("\n\n\n #########################################################\n")
        f.write(
            "il path per il file sarà creato come window/run_prefix+$(numero della run)+/run_postfix\n"
        )
        f.write(
            "quindi nel caso della prima finestra in questione sarà T038vshort/run1/lmp_data\n"
        )
